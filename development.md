...
### Модель данных
Для масштабируемости аналитики подготовлены **бизнес-справочники**. Также добавлен **календарь**, который поможет масштабировать аналитику, например, подлкючать таблицы с плановыми показателями.
