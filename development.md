...
Такое решение позволяет менеджменту оценить динамику с конкретными значениями. Не нужно перескакивать взглядом с оси на точку на графике. \
В то же время, метки данных не сливаются в кашу, а равномерно отмечены на графике, благодаря чему остается пространство для комфортного чтения.
