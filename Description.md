...
- Для модели данных были подготовлены бизнес-справочники и календарь с целью масштабирования аналитики, например, подключить таблицу с плановыми показателями  
