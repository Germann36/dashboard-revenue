...
> *В ближайшей перспективе данные будут загружаться через **API** в облачное хранилище **Object Storage** и подключаться к DataLens с помощью **Yandex Query**.* *В дальнейшем планируется переход на собственное **DWH** на основе **ClickHouse**.*
&nbsp;
