...
- Для модели данных были подготовлены бизнес-справочники и календарь с целью масштабирования аналитики. Например, для подключения таблицы с плановыми показателями. 
