...
- Для модели данных были подготовлены бизнес-справочники. Так же был добавлен календарь с целью масштабирования аналитики. Например, для подключения таблицы с плановыми показателями. 
